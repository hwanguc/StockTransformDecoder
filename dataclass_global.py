...
class G:
    ...
    d_model = 512
    dense_dim = 2048
    num_features = 5  # current, voltage, and soc at t minus G.window_size -> t minus 1
    num_heads = 8
    ...
    T_cur = 0.0
    # training
    epochs = 20 #21 should be T_i + a power of T_mult, ex) T_mult = 2 -> epochs = 2**5 + 1 = 32+1 = 33   257, original epoch number was 5.
